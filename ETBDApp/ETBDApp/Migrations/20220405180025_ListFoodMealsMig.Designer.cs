...
namespace ETBDApp.Migrations
{
    ...
    [Migration("20220405180025_ListFoodMealsMig")]
    partial class ListFoodMealsMig
    {
            ...
            modelBuilder.Entity("ETBDApp.Data.Entities.Meal", b =>
                {
                    ...
                    b.Property<int?>("FoodMealFoodId")
                        .HasColumnType("int");

                    b.Property<int?>("FoodMealMealId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FoodMealFoodId", "FoodMealMealId");
            ...
            modelBuilder.Entity("ETBDApp.Data.Entities.Meal", b =>
                {
                    ...
                    b.HasOne("ETBDApp.Data.Entities.FoodMeal", null)
                        .WithMany("Meals")
                        .HasForeignKey("FoodMealFoodId", "FoodMealMealId");
